...
5. bower init
6. bower install angularjs angular-route bootstrap modernizr jquery --save
7. bower install angular-animate --save-dev
8. npm init
9. npm install bower --save
10. npm install gulp gulp-clean gulp-concat gulp-ngdocs gulp-sass gulp-uglify run-sequence --save-dev
11. gulp watch
12. http-server
